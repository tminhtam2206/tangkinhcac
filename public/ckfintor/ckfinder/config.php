...
$config['licenseName'] = 'http://codemap.atwebpages.com/';
$config['licenseKey']  = '*X?Z-*1**-C**2-*D**-*T**-E*8*-3**G';
...
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => 'http://localhost/tangkinhcac/storage/app/public/', //Thư mục chứa file upload
