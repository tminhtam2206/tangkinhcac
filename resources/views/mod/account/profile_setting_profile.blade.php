...
<div class="card card-fluid">
    <h6 class="card-header" style="text-transform: uppercase;">Hồ Sơ Công Khai</h6>
    <div class="card-body">
        <div class="media mb-3">
            ...
            <div class="media-body pl-3">
                ...
                <h6 class="card-subtitle text-muted">Nhấn vào ảnh đại diện hiện tịa để thay đổi.</h6>
                <p class="card-text">
        ...
        <form method="post" action="{{ route('mod.tai_khoan.cap_nhat_thong_tin') }}">
            @csrf
