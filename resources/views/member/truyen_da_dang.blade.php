                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="align-middle text-right">
                                    <a href="{{ route('member.dashboard.my_story.add_chapter', ['name_slug'=>$val->name_slug]) }}" class="btn btn-sm btn-icon btn-secondary" data-toggle="tooltip" data-placement="bottom" title="Thêm chương"><i class="fas fa-plus"></i></a>
