								...
								<div class="dropdown-menu dropdown-menu-rich dropdown-menu-xl ml-n4 mw-100">
									...
									<div class="dropdown-scroll perfect-scrollbar h-auto" style="max-height: 360px">
										<div class="list-group list-group-flush list-group-reflow mb-2">
											...
											<div class="list-group-item py-2">
												<a href="https://awardspace.com" class="stretched-link" target="_blank"></a>
												<div class="tile tile-sm bg-muted">
											...
											<div class="list-group-item py-2">
												<a href="https://137.59.106.67/smb/database/list" class="stretched-link" target="_blank"></a>
												<div class="tile tile-sm bg-muted">
				...
				<div class="aside-menu overflow-hidden">
					<nav id="stacked-menu" class="stacked-menu">
						<ul class="menu">
							...
							<li class="menu-item">
								<a href="https://awardspace.com" class="menu-link" target="_blank">
									<span class="menu-icon fas fa-server"></span>
									<span class="menu-text">Máy Chủ</span>
								</a>
							</li>
							<li class="menu-item">
								<a href="https://137.59.106.67/smb/database/list" class="menu-link" target="_blank">
